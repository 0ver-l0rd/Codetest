import {
  require_react_is
} from "./chunk-SE54Z3DN.js";
import {
  require_react_dom
} from "./chunk-EXGY6B7D.js";
import {
  require_react
...
function getParentNode(node2) {
  ...
  const result = (
    ...
    (isShadowRoot(node2) ? node2.host : null) || // Fallback
...
var LiveRegion = function LiveRegion2(props) {
  ...
  var ScreenReaderText = jsx(import_react8.Fragment, null, jsx("span", {
    id: "aria-selection"
  }, ariaSelected), jsx("span", {
    id: "aria-context"
  }, ariaContext));
  var isInitialFocus = (ariaSelection === null || ariaSelection === void 0 ? void 0 : ariaSelection.action) === "initial-input-focus";
  return jsx(import_react8.Fragment, null, jsx(A11yText, {
    id
...
function ScrollManager(_ref3) {
  ...
  return jsx(import_react8.Fragment, null, lockEnabled && jsx("div", {
  ...
  _createClass(Select2, [{
    ...
    value: (
      ...
      function renderInput() {
        ...
        if (!isSearchable) {
          return React2.createElement(DummyInput, _extends({
            id,
        ...
        return React2.createElement(Input3, _extends({}, commonProps, {
          autoCapitalize: "none",
          autoComplete: "off",
          autoCorrect: "off",
          id,
    ...
    value: function renderPlaceholderOrValue() {
      ...
      if (!this.hasValue() || !controlShouldRenderValue) {
        return inputValue ? null : React2.createElement(Placeholder3, _extends({}, commonProps, {
          key: "placeholder",
          isDisabled,
          isFocused,
          innerProps: {
      ...
      if (isMulti) {
        return selectValue.map(function(opt, index2) {
          ...
          return React2.createElement(MultiValue3, _extends({}, commonProps, {
            components: {
      ...
      return React2.createElement(SingleValue3, _extends({}, commonProps, {
        data: singleValue,
        isDisabled
    ...
    value: function renderClearIndicator() {
      ...
      return React2.createElement(ClearIndicator3, _extends({}, commonProps, {
        innerProps,
        isFocused
      }));
    }
    ...
    value: function renderLoadingIndicator() {
      ...
      return React2.createElement(LoadingIndicator3, _extends({}, commonProps, {
        innerProps,
        isDisabled,
        isFocused
      }));
    ...
    value: function renderIndicatorSeparator() {
      ...
      var isFocused = this.state.isFocused;
      return React2.createElement(IndicatorSeparator3, _extends({}, commonProps, {
        isDisabled,
        isFocused
      }));
    }
    ...
    value: function renderDropdownIndicator() {
      ...
      return React2.createElement(DropdownIndicator3, _extends({}, commonProps, {
        innerProps,
        isDisabled,
        isFocused
      }));
    ...
    value: function renderMenu() {
      ...
      var render = function render2(props, id) {
        ...
        return React2.createElement(Option3, _extends({}, commonProps, {
          innerProps,
          data,
          isDisabled,
          isSelected,
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function(item) {
          if (item.type === "group") {
            ...
            return React2.createElement(Group3, _extends({}, commonProps, {
              key: groupId,
              data: _data,
              options: options2,
        ...
        if (message === null)
          return null;
        menuUI = React2.createElement(LoadingMessage3, commonProps, message);
      } else {
        ...
        if (_message === null)
          return null;
        menuUI = React2.createElement(NoOptionsMessage3, commonProps, _message);
      }
      ...
      var menuElement = React2.createElement(MenuPlacer, _extends({}, commonProps, menuPlacementProps), function(_ref4) {
        var ref = _ref4.ref, _ref4$placerProps = _ref4.placerProps, placement = _ref4$placerProps.placement, maxHeight = _ref4$placerProps.maxHeight;
        return React2.createElement(Menu3, _extends({}, commonProps, menuPlacementProps, {
          innerRef: ref,
          innerProps: {
          ...
          isLoading,
          placement
        }), React2.createElement(ScrollManager, {
          captureEnabled: captureMenuScroll,
          onTopArrive: onMenuScrollToTop,
          onBottomArrive: onMenuScrollToBottom,
          lockEnabled: menuShouldBlockScroll
        }, function(scrollTargetRef) {
          return React2.createElement(MenuList3, _extends({}, commonProps, {
      ...
      return menuPortalTarget || menuPosition === "fixed" ? React2.createElement(MenuPortal3, _extends({}, commonProps, {
    ...
    value: function renderFormField() {
      ...
      if (required && !this.hasValue()) {
        return React2.createElement(RequiredInput, {
          name,
      ...
      if (isMulti) {
        if (delimiter2) {
          ...
          return React2.createElement("div", null, input);
        }
      } else {
    ...
    value: function renderLiveRegion() {
      ...
      return React2.createElement(LiveRegion, _extends({}, commonProps, {
    ...
    value: function render() {
      ...
      return React2.createElement(SelectContainer3, _extends({}, commonProps, {
        className,
        innerProps: {
          id,
        ...
        isDisabled,
        isFocused
      }), this.renderLiveRegion(), React2.createElement(Control3, _extends({}, commonProps, {
        ...
        isFocused,
        menuIsOpen
      }), React2.createElement(ValueContainer3, _extends({}, commonProps, {
        isDisabled
      }), this.renderPlaceholderOrValue(), this.renderInput()), React2.createElement(IndicatorsContainer3, _extends({}, commonProps, {
        isDisabled
